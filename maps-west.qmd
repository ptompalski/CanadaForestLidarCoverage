...
<section class="column-screen subpage-hero-band">
  <div class="subpage-hero-copy">
    ...
    <p class="subpage-hero-lede">Regional static map layouts focused on British Columbia, Alberta, Saskatchewan, and adjacent western coverage. Use these views when you need the denser cartographic layouts rather than the homepage overview.</p>
  </div>
</section>
  ...
  <footer class="subpage-footer">
    <div class="subpage-footer-inner">
      <div>
        ...
        <p class="subpage-footer-copy">Static regional map products for western Canada.</p>
      </div>
