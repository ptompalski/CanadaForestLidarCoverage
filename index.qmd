...
This webpage accompanies the publication by White et al. 2025, and is designed to keep the statistics and maps presented in the paper up to date.

*White, J.C., Tompalski, P., Bater C.W., Wulder, M.A., Fortin, M., Hennigar C., Robere-McGugan, G., Sinclair, I., White, R., (2025). Enhanced forest inventories in Canada: implementation,
status, and research needs. Canadian Journal of Forest Research. http://dx.doi.org/10.1139/cjfr-2024-0255 *
...
![](img/map1_ALS_coverage.png){.lightbox}
