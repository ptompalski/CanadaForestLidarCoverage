...
::: {.column width="30%"}
![](img/paper.png){style="max-height:100px; object-fit:contain; display:block; margin:auto;"}
...
The map showing the overall ALS coverage is presented below. Additional [maps](maps.qmd) show [**acquisition year**](maps.qmd#maps-year), [**point cloud density**](maps.qmd#maps-density), and [**areas of multiple overlapping acquisitions**](multitemporal.qmd). More detailed maps are available for [western](maps-west.qmd) and [eastern](maps-east.qmd) parts of the country.
...
g <- girafe(ggobj = g, width_svg = 7, height_svg = 6)
